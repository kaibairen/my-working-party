...
P0 linkage add-on: empty slot **我来填** (human_allowed or exception_grant). Roster may show `last_heartbeat` when a bot posted `/v1/agents/heartbeat` within TTL (90s); still not dispatch.
